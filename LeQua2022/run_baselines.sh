...
#PYTHONPATH=.:.. python3 baselines.py multiclass ./data/T1B.train_dev_pkl/T1B/public ./model/T1B_npy npy &
...
PYTHONPATH=.:.. python3 baseline_quanet.py multiclass ./data/T1B.train_dev_pkl/T1B/public ./data/T1B.test_pkl/public/test_samples quanet_model/T1B predictions/T1B/quanet_dev.csv predictions/T1B/quanet_test.csv
...
PYTHONPATH=.:.. python3 baseline_quanet.py multiclass ./data/T2B.train_dev_BERT_pkl/T2B/public ./data/T2B.test_BERT_pkl/public/test_samples quanet_model/T2B predictions/T2B/quanet_dev.csv predictions/T2B/quanet_test.csv
